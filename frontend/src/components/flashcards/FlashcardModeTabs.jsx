...
export default function FlashcardModeTabs({ setId, active }) {
  return (
    <div className="inline-flex items-center gap-1 p-1 bg-surface-low rounded-2xl mb-6">
      {MODES.map(m => {
        ...
        return (
          <Link
            ...
            className={`inline-flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tsubaki-red/40 ${
              isActive
