...
const MONDAI_TYPES = {
  kanji_reading: {
    ...
    example: '{"question_text":"きのう＿映画＿を見ました。","options":["えいが","えいか","えが","えいご"],"correct_index":0,"explanation":"「映画」đọc là えいが — có trường âm えい và âm đục が.","translation_vi":"Hôm qua tôi đã xem ＿phim＿.\\n1. えいが 2. えいか 3. えが 4. えいご"}',
  },
  orthography: {
    ...
    example: '{"question_text":"この＿しんぶん＿はおもしろいです。","options":["新聞","親聞","新間","親間"],"correct_index":0,"explanation":"「新聞」= báo. Distractor đổi 新→親 và 聞→間 là các kanji hình dạng gần giống.","translation_vi":"＿Tờ báo＿ này thú vị.\\n1. 新聞 2. 親聞 3. 新間 4. 親間"}',
  },
  word_formation: {
    ...
    example: '{"question_text":"この製品は水に強く、耐久（　　）が高い。","options":["性","化","感","率"],"correct_index":0,"explanation":"「耐久性」= độ bền. Hậu tố 「～性」chỉ tính chất; 化/感/率 không ghép với 耐久.","translation_vi":"Sản phẩm này chịu nước tốt, độ bền（　　）cao.\\n1. 性 2. 化 3. 感 4. 率"}',
  },
  context: {
    ...
    example: '{"question_text":"つかれたので、少し（　　）ましょう。","options":["やすみ","あそび","はたらき","いそぎ"],"correct_index":0,"explanation":"Vì mệt (つかれた) nên hành động hợp lý là 「休む」= nghỉ. Ba lựa chọn kia đều là động từ nhưng ngược ngữ cảnh.","translation_vi":"Vì mệt nên hãy（　　）một chút.\\n1. nghỉ 2. chơi 3. làm việc 4. vội"}',
  },
  paraphrase: {
    ...
    example: '{"question_text":"このもんだいは＿やさしい＿です。","options":["かんたん","むずかしい","たいせつ","ゆうめい"],"correct_index":0,"explanation":"「やさしい」ở đây = dễ, gần nghĩa nhất với 「かんたん」. 「むずかしい」là từ trái nghĩa.","translation_vi":"Bài này ＿dễ＿.\\n1. đơn giản 2. khó 3. quan trọng 4. nổi tiếng"}',
  },
  usage: {
    ...
    example: '{"question_text":"しゅうかん","options":["毎朝コーヒーを飲むのが父のしゅうかんだ。","この店のしゅうかんはとても親切だ。","電車のしゅうかんは10分おきだ。","彼は日本語のしゅうかんが上手だ。"],"correct_index":0,"explanation":"「習慣」= thói quen lặp lại của một người. Câu 2 phải dùng 「店員」, câu 3 dùng 「間隔」, câu 4 dùng 「発音」.","translation_vi":"Từ cho trước: しゅうかん (thói quen)\\n1. Uống cà phê mỗi sáng là thói quen của bố tôi. 2. ... của quán này rất thân thiện. 3. ... của tàu là 10 phút một chuyến. 4. Anh ấy giỏi ... tiếng Nhật."}',
  },
  grammar_form: {
    ...
    example: '{"question_text":"雨が降っていた（　　）、試合は中止になった。","options":["ので","のに","でも","ながら"],"correct_index":0,"explanation":"Quan hệ nguyên nhân–kết quả → 「ので」. 「のに」mang nghĩa nghịch ý, không hợp với kết quả hủy trận đấu.","translation_vi":"（　　）trời đang mưa nên trận đấu đã bị hủy.\\n1. ので 2. のに 3. でも 4. ながら"}',
  },
  sentence_assembly: {
    ...
    example: '{"question_text":"わたしは　＿＿＿　＿★＿　＿＿＿　＿＿＿　思っています。","options":["日本へ","来年","行きたいと","ぜひ"],"correct_index":3,"explanation":"Thứ tự đúng: 来年 → ぜひ → 日本へ → 行きたいと。Vị trí ★ là ô thứ 2 nên đáp án là 「ぜひ」(lựa chọn 4).","translation_vi":"Tôi đang nghĩ nhất định năm sau muốn đi Nhật.\\n1. đến Nhật 2. năm sau 3. muốn đi 4. nhất định"}',
  },
  text_grammar: {
    ...
    example: '{"question_text":"（１）","options":["だから","でも","それに","たとえば"],"correct_index":1,"explanation":"Câu trước nói muốn đi chơi, câu sau nói trời mưa nên không đi được → quan hệ nghịch ý, dùng 「でも」.","translation_vi":"Chỗ trống (1)\\n1. vì vậy 2. nhưng 3. hơn nữa 4. ví dụ"}',
  },
  reading_short: {
    ...
    example: '{"question_text":"この文章の内容と合っているものはどれか。","options":["田中さんは今週の会議に出られない。","田中さんは会議の場所を変えたい。","会議は来週の月曜日に行われる。","会議の資料はまだできていない。"],"correct_index":0,"explanation":"Đoạn văn viết 「出張のため今週の会議には参加できません」→ Tanaka không dự họp tuần này được.","translation_vi":"Nội dung nào đúng với bài đọc?\\n1. Tanaka không dự được cuộc họp tuần này. 2. Tanaka muốn đổi địa điểm họp. 3. Cuộc họp diễn ra thứ Hai tuần sau. 4. Tài liệu họp chưa xong."}',
  },
  reading_mid: {
    ...
    example: '{"question_text":"筆者が＿そう考える＿のはなぜか。","options":["経験から学ぶことのほうが多いから","本を読む時間が足りないから","学校の勉強が役に立たないから","失敗を避けたいから"],"correct_index":0,"explanation":"Đoạn 2 viết 「失敗して初めて分かることがある」— tác giả cho rằng học từ trải nghiệm được nhiều hơn.","translation_vi":"Vì sao tác giả ＿nghĩ như vậy＿?\\n1. Vì học từ trải nghiệm được nhiều hơn. 2. Vì không đủ thời gian đọc sách. 3. Vì học ở trường không có ích. 4. Vì muốn tránh thất bại."}',
  },
  reading_long: {
  ...
  integrated_reading: {
    ...
    example: '{"question_text":"在宅勤務について、ＡとＢはどのような点で共通しているか。","options":["通勤の負担が減ることを認めている点","制度の廃止を求めている点","若い社員だけに向くと考えている点","生産性が必ず上がると述べている点"],"correct_index":0,"explanation":"Ａ viết 「通勤時間がなくなる利点」, Ｂ viết 「移動の負担が軽い」— cả hai đều công nhận giảm gánh nặng đi lại, dù kết luận cuối khác nhau.","translation_vi":"Về làm việc tại nhà, Ａ và Ｂ giống nhau ở điểm nào?\\n1. Đều thừa nhận giảm gánh nặng đi lại. 2. Đều yêu cầu bãi bỏ chế độ này. 3. Đều cho rằng chỉ hợp với nhân viên trẻ. 4. Đều nói năng suất chắc chắn tăng."}',
  },
  thematic_reading: {
    ...
    example: '{"question_text":"筆者の主張として最も適切なものはどれか。","options":["効率だけを追い求める姿勢を見直すべきだ","伝統的な手法をすべて守るべきだ","若い世代に任せておけばよい","議論より行動を優先すべきだ"],"correct_index":0,"explanation":"Xuyên suốt bài, tác giả phê phán 「効率至上主義」và kết bằng 「立ち止まって考える必要がある」— chủ trương là xem lại thái độ chỉ chạy theo hiệu quả.","translation_vi":"Chủ trương của tác giả là gì?\\n1. Cần xem lại thái độ chỉ theo đuổi hiệu quả. 2. Phải giữ toàn bộ phương pháp truyền thống. 3. Cứ giao hết cho thế hệ trẻ. 4. Nên ưu tiên hành động hơn bàn luận."}',
  },
  info_retrieval: {
  ...
  utterance_expression: {
    ...
    example: '{"question_text":null,"options":["すみません、写真を撮ってもらえませんか。","すみません、写真を撮りましょうか。","すみません、写真を撮ってあげます。"],"correct_index":0,"explanation":"Người mũi tên muốn NHỜ người khác chụp ảnh hộ mình → 「撮ってもらえませんか」. Lựa chọn 2–3 là ngỏ ý chụp giúp người kia, ngược tình huống.","translation_vi":"Tình huống (có tranh): Người mũi tên muốn nhờ người qua đường chụp ảnh giúp.\\n1. Xin lỗi, anh chụp ảnh giúp tôi được không? 2. Xin lỗi, để tôi chụp ảnh cho nhé? 3. Xin lỗi, tôi sẽ chụp ảnh cho anh.","audio_transcript":"旅行先で写真を撮りたいです。近くの人にお願いします。何と言いますか。\\n女：\\n１　すみません、写真を撮ってもらえませんか。\\n２　すみません、写真を撮りましょうか。\\n３　すみません、写真を撮ってあげます。"}',
  },
  quick_response: {
    ...
    no_question_text: true,
    example: '{"question_text":null,"options":["ええ、おかげさまで。","はい、行ってきます。","いいえ、まだです。"],"correct_index":0,"explanation":"「お元気でしたか」là câu hỏi thăm sức khỏe → đáp tự nhiên là 「ええ、おかげさまで」. Hai câu còn lại trả lời cho ngữ cảnh khác.","translation_vi":"Câu mở: Lâu rồi không gặp. Dạo này anh khỏe chứ?\\n1. Vâng, nhờ trời ạ. 2. Vâng, tôi đi đây. 3. Không, vẫn chưa.","audio_transcript":"男：お久しぶりです。お元気でしたか。\\n女：\\n１　ええ、おかげさまで。\\n２　はい、行ってきます。\\n３　いいえ、まだです。"}',
  },
